...
// Values taken from the Figma mockups. The palette is deliberately light-only:
// the design has no dark variant, and Info.plist pins UIUserInterfaceStyle to
// Light so alerts, menus and the keyboard agree with it.
extension Color {
